...
public class BackgroundSubtraction extends FunctionTemplate {
	...
	public BackgroundSubtractionFunction newInstance(Stmt stmt) {
		return new BackgroundSubtractionFunction(stmt, this);
	}
