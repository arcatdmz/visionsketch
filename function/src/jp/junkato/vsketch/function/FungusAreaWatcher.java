...
public class FungusAreaWatcher extends FunctionTemplate {
	...
	public FungusAreaWatcherFunction newInstance(Stmt stmt) {
		return new FungusAreaWatcherFunction(stmt, this);
	}
